...
export default function StockExitModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (currentStock - quantity < 0) {
      toast.error('No se puede salir más stock del disponible')
      return
    }
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              placeholder="Ej: Venta al cliente"
          ...
          <div className="mb-6">
            <p className="text-caption text-red-500 dark:text-red-400 mb-2">
              ⚠ Stock después de esta salida no puede ser negativo
            </p>
          </div>
